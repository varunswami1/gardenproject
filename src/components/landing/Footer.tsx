      ...
      <div className="container-padding py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-neutral-600 text-sm">
              The Plantona Guide is here to help you plant, care and grow for
              your plants. Everything you need to know to make plant care
              simple.
            </p>
          </div>
        ...
        <div className="border-t border-neutral-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-neutral-600">
            © 2025 Plantona. All rights reserved.
          </p>
